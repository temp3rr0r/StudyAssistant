...
class Bmp085 : public Sensor, public ISensor {
private:
...
Bmp085::Bmp085() : Bmp085(* new DbParameters("Bmp085" , "dlid", "digitallist", "value", "did", "digital", "aq")) { }

Bmp085::Bmp085(DbParameters newDbParameters) {
}
